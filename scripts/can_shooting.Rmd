...
```{r}
mdl_maxH2_lip_vPos <- brm(f0_mean ~ 1 + vowel_s + can_size_s + 
                      h_pos + v_pos + height +
                      (1 + vowel_s + can_size_s + 
                         h_pos + v_pos || speaker),
                   data = can,
...
```{r}
if (file.exists(paste0(models, "mdl_maxH2_lip_vPos_reloo.rds"))) {
  mdl_maxH2_lip_vPos_reloo <- readRDS(paste0(models, "mdl_maxH2_lip_vPos_reloo.rds"))
} else {
  mdl_maxH2_lip_vPos_reloo <- reloo(mdl_maxH2_lip_vPos_loo, mdl_maxH2_lip_vPos, chains = 1)
  saveRDS(mdl_maxH2_lip_vPos_reloo, paste0(models, "mdl_maxH2_lip_vPos_reloo.rds"))
}

mdl_maxH2_lip_vPos_reloo
```
...
```{r}
mdl_maxH2_form_vPos <- brm(f0_mean ~ 1 + vowel_s + can_size_s + 
                      h_pos + v_pos + height +
                      (1 + vowel_s + can_size_s + 
                         h_pos + v_pos || speaker),
                   data = can,
