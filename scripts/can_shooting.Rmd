...
Visually, they are basically the same. I think it is better to go with head position then, becasue it captures exactly the movement of interest.
...
```{r}
if (file.exists(paste0(models, "mdl_noRandomH1_headPos_reloo.rds"))) {
  mdl_noRandomH1_headPos_reloo <- readRDS(paste0(models, "mdl_noRandomH1_headPos_reloo.rds"))
} else {
