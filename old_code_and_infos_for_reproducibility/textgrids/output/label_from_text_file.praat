...
# The script will jump over intervals labeled as "p". Use this marking if there are intervals that
...
sentence Filename C:\Users\ola\OneDrive\PSIMS\2018-f0-can\scripts\list-1-part1.txt
...
comment (Intervals previously marked with '-' will be skipped despite this!)
boolean Overwrite 1
endform
